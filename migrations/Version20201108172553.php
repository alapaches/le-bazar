 ...
 */
final class Version20201108172553 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__objet AS SELECT id, piece_id, nom FROM objet');
        $this->addSql('DROP TABLE objet');
        $this->addSql('CREATE TABLE objet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, piece_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, catã©gorie VARCHAR(255) NOT NULL, CONSTRAINT FK_46CD4C38C40FCFA8 FOREIGN KEY (piece_id) REFERENCES piece (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO objet (id, piece_id, nom) SELECT id, piece_id, nom FROM __temp__objet');
