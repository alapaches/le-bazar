 ...
 */
final class Version20201122221303 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE objet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, piece_id INTEGER NOT NULL, lieu_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, categorie VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_46CD4C38C40FCFA8 FOREIGN KEY (piece_id) REFERENCES piece (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_46CD4C386AB213CC FOREIGN KEY (lieu_id) REFERENCES lieu (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_46CD4C386AB213CC ON objet (lieu_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2F577D59C40FCFA8 ON lieu (piece_id)');
        $this->addSql('DROP INDEX IDX_46CD4C38C40FCFA8');
        $this->addSql('DROP INDEX IDX_46CD4C386AB213CC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__objet AS SELECT id, piece_id, nom, categorie FROM objet');
        $this->addSql('DROP TABLE objet');
