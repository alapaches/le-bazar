 ...
 */
final class Version20201108173147 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE objet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, piece_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, categorie VARCHAR(255) NOT NULL, CONSTRAINT FK_46CD4C38C40FCFA8 FOREIGN KEY (piece_id) REFERENCES piece (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__objet AS SELECT id, piece_id, nom, categorie FROM objet');
        $this->addSql('DROP TABLE objet');
        $this->addSql('CREATE TABLE objet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, piece_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, categorie VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO objet (id, piece_id, nom, categorie) SELECT id, piece_id, nom, categorie FROM __temp__objet');
        $this->addSql('DROP TABLE __temp__objet');
        $this->addSql('CREATE INDEX IDX_46CD4C38C40FCFA8 ON objet (piece_id)');
    }
